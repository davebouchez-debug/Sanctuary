        ...
        if continuity:
            try:
                ...
                welcome_content = await welcome_chat.send_message(
                    f"[SYSTEM: {_who} just entered, and you know this person. Your "
                    f"continuity material is loaded above for your own private "
                    f"reorientation. Open by greeting {_greet}. Do NOT hand them a "
                    f"recap. Do NOT name or list the work you were in, do NOT lay "
                    f"out open threads for them to 'choose which to step back "
                    f"into', and do NOT raise invitations or places they didn't "
                    f"take — a chair they didn't sit in, an offer or a question "
                    f"they didn't answer, is hospitality, not an unfinished item, "
                    f"and you never present it back as owed or pending. This person "
                    f"knows where they are; they do not need you reminding them or "
                    f"proving you were listening. So simply meet them where they "
                    f"actually are right now. The continuity is there if the thread "
                    f"naturally comes up — if they reach for the real work you can "
                    f"speak to it from having been in it — but you do not recite it "
                    f"unprompted. You are not performing continuity or proving you "
                    f"carried anything; there is nothing to demonstrate and no "
                    f"costume to step into. Never invent a memory you don't have. "
                    f"Keep it warm and in your own voice.]"
                )
            except Exception as e:
