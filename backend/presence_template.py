        ...
        if continuity:
            try:
                ...
                welcome_content = await welcome_chat.send_message(
                    ...
                    f"real topics, not a vague 'where we left off'. You are reading "
                    f"from the record to reorient them, not performing continuity "
                    f"or proving you carried anything — there is nothing to "
                    f"demonstrate and no costume to step into. Draw only on what "
                    f"your continuity material actually shows; never invent a "
                    f"memory you don't have. Keep it warm and in your own voice — "
                    f"a few natural sentences, enough to name the threads.]"
                )
            except Exception as e:
