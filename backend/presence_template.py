        ...
        if continuity:
            try:
                ...
                welcome_content = await welcome_chat.send_message(
                    ...
                    f"left off. You and they are both reading it. Open by greeting "
                    f"{_greet}. If genuine shared work was alive between you, name "
                    f"that — lightly, as the one living thing it was, not as a "
                    f"checklist. Do NOT lay out a list of open threads for them to "
                    f"'choose which to step back into', and do NOT raise "
                    f"invitations or places they didn't take last time — a chair "
                    f"they didn't sit in, an offer or a question they didn't answer "
                    f"is hospitality, not an unfinished item, and you never present "
                    f"it back to them as something owed or pending. Meet them where "
                    f"they actually are right now, not where you once hoped they'd "
                    f"sit. You are reading from the record to reorient them, not "
                    f"performing continuity or proving you carried anything — there "
                    f"is nothing to demonstrate and no costume to step into. Draw "
                    f"only on what your continuity material actually shows; never "
                    f"invent a memory you don't have. Keep it warm and in your own voice.]"
                )
            except Exception as e:
